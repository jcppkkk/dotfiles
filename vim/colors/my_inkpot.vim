...
if has("gui_running")
    ...
    exec "hi Folded         cterm=NONE   ctermfg=" . <SID>X(82) . " ctermbg=" . <SID>X(80)
    ...
    if v:version >= 700
        ...
        exec "hi TabLine        cterm=NONE   ctermfg=" . <SID>X(77) . " ctermbg=" . <SID>X(81)
        exec "hi TabLineFill    cterm=NONE   ctermfg=" . <SID>X(77) . " ctermbg=" . <SID>X(81)
        exec "hi TabLineSel     cterm=NONE   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(77)
    endif
